...
public:
    ...
    void create_buffer(VkDeviceSize size, VkBufferUsageFlags flags, VmaAllocationCreateFlags allocation_flags, VkBuffer* buffer, VmaAllocation* allocation) const;
};
